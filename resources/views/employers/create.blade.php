    ...
    <div class="container">
        <div class="card shadow-lg border-0 rounded-3">
            <div class="card-header bg-primary text-white">
                <h4 class="mb-0">Submit Employer Survey</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('employers.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-md-6 mb-3">
                            ...
                            <input type="tel" class="form-control @error('employee_name') is-invalid @enderror"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('graduate_id') is-invalid @enderror"
                                ...
                                @foreach($graduates as $graduate)
                                    <option value="{{ $graduate->id }}" {{ old('graduate_id') == $graduate->id ? 'selected' : '' }}>
                                        {{ $graduate->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('q1') is-invalid @enderror"
                                ...
                                <option value=""></option>
                                <option value="1" {{ old('q1') == '1' ? 'selected' : '' }}>Excellent</option>
                                <option value="2" {{ old('q1') == '2' ? 'selected' : '' }}>Good</option>
                                <option value="3" {{ old('q1') == '3' ? 'selected' : '' }}>Average</option>
                                <option value="4" {{ old('q1') == '4' ? 'selected' : '' }}>Poor</option>
                            </select>
                            @error('q1')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="tel" class="form-control @error('q2') is-invalid @enderror"
                                id="q2" name="q2" value="{{ old('q2') }}" required
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="tel" class="form-control @error('q3') is-invalid @enderror"
                                id="q3" name="q3" value="{{ old('q3') }}" required
                                placeholder="e.g. Technical Skills, Problem-Solving">
                            @error('q3')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('q5') is-invalid @enderror"
                                ...
                                <option value=""></option>
                                <option value="1" {{ old('q5') == '1' ? 'selected' : '' }}>Very Well</option>
                                <option value="2" {{ old('q5') == '2' ? 'selected' : '' }}>Well</option>
                                <option value="3" {{ old('q5') == '3' ? 'selected' : '' }}>Fairly Well</option>
                                <option value="4" {{ old('q5') == '4' ? 'selected' : '' }}>Not well at all</option>
                            </select>
                            @error('q5')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('q6') is-invalid @enderror"
                                ...
                                <option value=""></option>
                                <option value="1" {{ old('q6') == '1' ? 'selected' : '' }}>Very Quickly</option>
                                <option value="2" {{ old('q6') == '2' ? 'selected' : '' }}>Quickly</option>
                                <option value="3" {{ old('q6') == '3' ? 'selected' : '' }}>Moderately</option>
                                <option value="4" {{ old('q6') == '4' ? 'selected' : '' }}>Slowly</option>
                            </select>
                            @error('q6')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('q7') is-invalid @enderror"
                                ...
                                <option value=""></option>
                                <option value="1" {{ old('q7') == '1' ? 'selected' : '' }}>Very effective</option>
                                <option value="2" {{ old('q7') == '2' ? 'selected' : '' }}>Effective</option>
                                <option value="3" {{ old('q7') == '3' ? 'selected' : '' }}>Neutral</option>
                                <option value="4" {{ old('q7') == '4' ? 'selected' : '' }}>Ineffective</option>
                            </select>
                            @error('q7')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('q8') is-invalid @enderror"
                                ...
                                <option value=""></option>
                                <option value="1" {{ old('q8') == '1' ? 'selected' : '' }}>Very well</option>
                                <option value="2" {{ old('q8') == '2' ? 'selected' : '' }}>Well</option>
                                <option value="3" {{ old('q8') == '3' ? 'selected' : '' }}>Adequately</option>
                                <option value="4" {{ old('q8') == '4' ? 'selected' : '' }}>Poorly</option>
                            </select>
                            @error('q8')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('q9') is-invalid @enderror"
                                ...
                                <option value=""></option>
                                <option value="1" {{ old('q9') == '1' ? 'selected' : '' }}>Excellent</option>
                                <option value="2" {{ old('q9') == '2' ? 'selected' : '' }}>Good</option>
                                <option value="3" {{ old('q9') == '3' ? 'selected' : '' }}>Fair</option>
                                <option value="4" {{ old('q9') == '4' ? 'selected' : '' }}>Poor</option>
                            </select>
                            @error('q9')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('q10') is-invalid @enderror"
                                ...
                                <option value=""></option>
                                <option value="1" {{ old('q10') == '1' ? 'selected' : '' }}>Always</option>
                                <option value="2" {{ old('q10') == '2' ? 'selected' : '' }}>Often</option>
                                <option value="3" {{ old('q10') == '3' ? 'selected' : '' }}>Occasionally</option>
                                <option value="4" {{ old('q10') == '4' ? 'selected' : '' }}>Never</option>
                            </select>
                            @error('q10')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('q11') is-invalid @enderror"
                                ...
                                <option value=""></option>
                                <option value="1" {{ old('q11') == '1' ? 'selected' : '' }}>Excellent</option>
                                <option value="2" {{ old('q11') == '2' ? 'selected' : '' }}>Good</option>
                                <option value="3" {{ old('q11') == '3' ? 'selected' : '' }}>Fair</option>
                                <option value="4" {{ old('q11') == '4' ? 'selected' : '' }}>Poor</option>
                            </select>
                            @error('q11')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('q12') is-invalid @enderror"
                                ...
                                <option value=""></option>
                                <option value="1" {{ old('q12') == '1' ? 'selected' : '' }}>Very professional</option>
                                <option value="2" {{ old('q12') == '2' ? 'selected' : '' }}>Professional</option>
                                <option value="3" {{ old('q12') == '3' ? 'selected' : '' }}>Somewhat professional</option>
                                <option value="4" {{ old('q12') == '4' ? 'selected' : '' }}>Unprofessional</option>
                            </select>
                            @error('q12')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('q13') is-invalid @enderror"
                                ...
                                <option value=""></option>
                                <option value="1" {{ old('q13') == '1' ? 'selected' : '' }}>Yes, definitely</option>
                                <option value="2" {{ old('q13') == '2' ? 'selected' : '' }}>Yes, potentially</option>
                                <option value="3" {{ old('q13') == '3' ? 'selected' : '' }}>Uncertain</option>
                                <option value="4" {{ old('q13') == '4' ? 'selected' : '' }}>No</option>
                            </select>
                            @error('q13')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('q14') is-invalid @enderror"
                                ...
                                <option value=""></option>
                                <option value="1" {{ old('q14') == '1' ? 'selected' : '' }}>Yes</option>
                                <option value="2" {{ old('q14') == '2' ? 'selected' : '' }}>No</option>
                                <option value="3" {{ old('q14') == '3' ? 'selected' : '' }}>Unsure</option>
                            </select>
                            @error('q14')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
