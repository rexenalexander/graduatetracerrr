...
<div class="container-fluid px-4">
    <div class="d-md-flex d-block justify-content-between align-items-center mb-4">
        ...
        <button type="button" class="btn btn-sm btn-danger" >
            <a href="{{ route('admin.clearjobs') }}" >
                Clear Queue Email <b class="text-warning">({{$jobCount ?? 0}} Pending)</b>
            </a>
        </button>
    </div>
    ...
    <div class="card shadow-sm">
        ...
        <div class="d-flex">
            <!-- Excel Upload Form -->
            <form action="{{ route('admin.graduates.notifygraduate') }}" method="POST" enctype="multipart/form-data" class="w-100">
                @csrf
                    <div class="mb-3">
